(function () {
    ...
    var qa = Array.prototype.indexOf ? function (a, b, c) {
        ...
        x = Array.prototype.forEach ? function (a, b, c) {
            ...
            for (var d = a.length, e = l(a) ? a.split("") : a, h = 0; h < d; h++) h in e && b.call(c, e[h], h, a)
        };
    ...
    var Ja = A("Opera"),
        F = A("Trident") || A("MSIE"),
        Ka = A("Edge"),
        G = A("Gecko") && !(-1 != z.toLowerCase().indexOf("webkit") && !A("Edge")) && !(A("Trident") || A("MSIE")) && !A("Edge"),
        La = -1 != z.toLowerCase().indexOf("webkit") && !A("Edge");
    ...
    function H(a) {
        return Ha(a, function () {
            for (var b = 0, c = ia(String(Ra)).split("."), d = ia(String(a)).split("."), e = Math.max(c.length, d.length), h = 0; 0 == b && h < e; h++) {
                var g = c[h] || "",
                    m = d[h] || "";
                do {
                    g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
                    ...
                    b = w(0 == g[1].length ? 0 : parseInt(g[1], 10), 0 == m[1].length ? 0 : parseInt(m[1], 10)) || w(0 == g[2].length, 0 == m[2].length) || w(g[2], m[2]);
                    g = g[3];
                    m = m[3]
                } while (0 == b)
            }
    ...
    var Sa;
    var Ta = k.document;
    Sa = Ta && F ? Ma() || ("CSS1Compat" == Ta.compatMode ? parseInt(Ra, 10) : 5) : void 0;
    var Ua;
    if (!(Ua = !G && !F)) {
        var Va;
        if (Va = F) Va = 9 <= Number(Sa);
        Ua = Va
    }
    Ua || G && H("1.9.1");
    F && H("9");
    ...
    function Wa(a, b) {
        ...
        if (a) {
            ...
            for (c = d = 0; e = h[c]; c++) {
                var m = e.className,
                    Z;
                if (Z = "function" == typeof m.split) Z = 0 <= qa(m.split(/\s+/), a);
                Z && (g[d++] = e)
            }
            g.length = d;
            return g
    ...
    F && H("9");
    !La || H("528");
    G && H("1.9b") || F && H("8") || Ja && H("9.5") || La && H("528");
    G && !H("8") || F && H("9");
        ...
        if (c) {
            ...
            if (this.v)
                for (e = 0; e < c.length; e++) {
                    var g = c[e];
                    cb(this.a[g + 1], this.a[g + 2], d)
                } else {
                    this.h++;
                    try {
                        for (e = 0, h = c.length; e < h; e++) g = c[e], this.a[g + 1].apply(this.a[g + 2], d)
                    } finally {
    ...
    function pb(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in N ? N.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), nb("ERRORS", c))
    };
    var qb = 0;
    u("ytDomDomGetNextId", n("ytDomDomGetNextId") || function () {
        return ++qb
    });
    var rb = {
    ...
    function O(a) {
        ...
        if (a = a || window.event) {
            this.a = a;
            for (var b in a) b in rb || (this[b] = a[b]);
    ...
    var sb = n("ytEventsEventsCounter") || {
        count: 0
    };
    u("ytEventsEventsCounter", sb);
    ...
    function vb(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                g = ob(g);
                a.addEventListener ? ("mouseenter" == b && h ? b = "mouseover" : "mouseleave" == b && h ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), a.addEventListener(b, g, d)) : a.attachEvent("on" + b, g);
                B[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function yb(a) {
        return xb[a] || (xb[a] = String(a).replace(/\-([a-z])/g, function (a, c) {
    ...
    function Q(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[yb(b)] : a.getAttribute("data-" + b) : null
    }
    ...
    function R(a, b, c) {
        ...
        if (a = l(a) ? c.getElementById(a) : a)
            if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? jb(a.src) : "https://www.youtube.com"), this.b = new S(b), c || (b = Eb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[r] || (a[r] = ++ca), b.id = "widget" + a), P[this.a.id] = this, window.postMessage) {
                this.f = new K;
                Fb(this);
                b = T(this.b, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in Ab) Gb(this, e)
            }
    }
    f = R.prototype;
    f.S = function (a, b) {
    ...
    function Fb(a) {
        Ib(a.b, a, a.g);
        a.c = wb(t(a.H, a));
        vb(a.a, "load", t(function () {
            window.clearInterval(this.c);
            this.c = wb(t(this.H, this))
        }, a))
    }
    ...
    Y.prototype.setVideoDescription = Y.prototype.K;
    Y.prototype.setVideoKeywords = Y.prototype.M;
    Y.prototype.setVideoPrivacy = Y.prototype.N;
    Y.prototype.setVideoTitle = Y.prototype.O;
    Y.prototype.setVideoDraftPrivacy = Y.prototype.L;
    zb.push(function (a) {
        a = Cb("player", a);
        x(a, Lb)
    });
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Bb();
    var Qb = n("onYTReady");
    Qb && Qb();
